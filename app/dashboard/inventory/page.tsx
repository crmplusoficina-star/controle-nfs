  ...
  return (
    <>
      <div className="max-w-6xl mx-auto px-4 md:px-6 pt-5 flex flex-col sm:flex-row justify-end gap-2">
        <a href="/dashboard/inventory/manual" className="px-4 py-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-white font-black uppercase tracking-widest text-[10px] transition-colors text-center">
          + Adicionar manual em massa
        </a>
